...
const targetStr = `      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex justify-between items-center mb-6">
        <div>
          <h2 className="text-xl font-bold text-slate-800">
            گزارش ABC (تسهیم هزینه)
          </h2>
...
const replacementStr = `      <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col md:flex-row justify-between md:items-center gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
           ...
           <div className="flex flex-col justify-end gap-1 self-stretch">
              <span className="text-xs text-transparent hidden md:block">خروجی</span>
              <ExportPrintButtons moduleName="sales" period="" fileName="Cost_Allocation" />
           </div>
        </div>
      </div>`;
